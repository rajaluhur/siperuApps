...
const MyScene = ({ onObjectLoaded }) => {
  ...
  return (
    <ViroARScene onTrackingUpdated={anchorFound}>
      ...
      <Viro3DObject
            source={require('../model/calcium/calcium.obj')}
            resources={[
              require('../model/calcium/texture.mtl'),
              require('../model/calcium/Tetra_Rex_diffuse.png'),
            ]}
            scale={[0.05, 0.05, 0.05]}
            rotation={[0, 150, 0]}
            position={[0.15, 0.15, -0.54]} // Adjust the position if necessary
            type="OBJ"
      ...
      <ViroImage
          ...
          source={require('../model/calcium/text.png')}
      />
    </ViroARScene>
  );
};
