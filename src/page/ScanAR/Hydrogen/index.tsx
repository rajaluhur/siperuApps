...
const MyScene = ({ onObjectLoaded }) => {
  ...
  return (
    <ViroARScene onTrackingUpdated={anchorFound}>
      ...
      <Viro3DObject
            source={require('../model/hydrogen/hydrogen.obj')}
            resources={[
              require('../model/hydrogen/texture.mtl'),
              require('../model/hydrogen/lambert6_baseColor.jpeg'),
              require('../model/hydrogen/lambert6_normal.png'),
            ]}
      ...
      <ViroImage
          ...
          source={require('../model/hydrogen/text.png')}
      />
    </ViroARScene>
  );
};
